...
def test_main_missing_model(monkeypatch, tmp_path):
    ...
    # Dummy text_splitters module used in various locations
    ...
    monkeypatch.setitem(sys.modules, "langchain_community.text_splitters", lc_splitters)
    monkeypatch.setitem(sys.modules, "langchain_community.text_splitter", lc_splitters)
